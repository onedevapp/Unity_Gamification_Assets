...
public class SimpleCSVDemo : MonoBehaviour
{
    ...
    public InputField rankInputField; // Reference of rank input filed
    public Text contentArea; // Reference of contentArea where records are displayed

    string fileName = "/OneDevApp/SimpleCSV/Demo/files/SampleCSV.csv";
    ...
    public void addData()
    {
        ...
        rows.Add("Rank", rankInputField.text);
